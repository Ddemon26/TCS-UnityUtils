...
namespace TCS.UnityUtils.Extensions {
    public static class UIToolkitExtensions {
        ...
        public static Vector2 GetScreenCoordinate(this Vector2 clickPosition, VisualElement rootVisualElement) {
            ...
            var normalizedPosition = clickPosition.NormalizeClickEventPosition(rootVisualElement);
        ...
        public static void AlignToGameObject(this VisualElement element, GameObject gameObject, Camera camera, VisualElement rootElement) {
            if (!gameObject || !camera || rootElement == null)
                return;
            ...
            var localPos = ScreenToLocal(rootElement, screenPos);
        ...
        static Vector2 ScreenToLocal(VisualElement rootElement, Vector3 screenPos) {
